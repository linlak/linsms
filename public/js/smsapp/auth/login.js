(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/smsapp/auth/login"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    perform_login: function perform_login() {
      alert("It works");
    }
  }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "col-10 col-sm-6 offset-1 offset-sm-3" }, [
      _c(
        "form",
        {
          staticClass: "form mt-5 shadow-sm p-3 bg-info rounded",
          attrs: { name: "login_form", novalidate: "" },
          on: {
            submit: function($event) {
              return _vm.perform_login()
            }
          }
        },
        [
          _c("h3", { staticClass: "text-center my-3" }, [_vm._v("Login")]),
          _vm._v(" "),
          _c("div", { staticClass: "form-group" }, [
            _c("div", [
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.auth_user.username,
                    expression: "auth_user.username"
                  }
                ],
                ...
                domProps: { value: _vm.auth_user.username },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.auth_user, "username", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
              ...
              _c("input", {
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.$set(_vm.auth_user, "password", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
            ...
            _c(
              ...
              [
                _c(
                  "router-link",
                  {
                    staticClass: "card-link text-white-50",
                    attrs: { to: { name: "passrec" } }
                  },
