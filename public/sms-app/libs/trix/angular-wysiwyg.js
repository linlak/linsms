  ...
  angular.module('wysiwyg.module', ['colorpicker.module']).directive('wysiwyg', [
        ...
        function configureListeners() {
          ...
          textarea.on('click keyup focus mouseup', function () {
            $timeout(function () {
              ...
              scope.isSelectAll = scope.cmdState('selectall');
              ...
              scope.isFullyJustified=scope.cmdState('justifyfull');
    ...
    'select-all': {
      ...
      attributes: [
        ...
        {
          name: 'ng-click',
          value: 'format(\'selectAll\')'
        },
        {
          name: 'ng-class',
          value: '{ active: isSelectAll }'
        },
        {
          name: 'type',
          value: 'button'
