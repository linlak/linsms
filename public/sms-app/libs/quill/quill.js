            ...
            function(module, exports, __webpack_require__) {
                ...
                function makeEmbedArrowHandler(key, shiftKey) {
                    ...
                    return (
                        ...
                        _defineProperty(_ref3, "handler", function handler(
                            range
                        ) {
                        ...
                        [
                            {
                                ...
                                value: function create(value) {
                                    ...
                                    // if (value.contains(window.location.hostname)||String.startsWith('/')){
                                    //     return node;
                                    // }else{
            ...
            function(module, exports, __webpack_require__) {
                                    ...
                                    link: function link(value) {
                                        if (value) {
                                            ...
                                            if (
                                                ...
                                                return;
                                            var preview = this.quill.getText(
                                                range
                                            );
                                            if (
                                                /^\S+@\S+\.\S+$/.test(
                ...
                var SnowTooltip = (function(_BaseTooltip) {
                    ...
                    function SnowTooltip(quill, bounds) {
                        ...
                        _this2.preview = _this2.root.querySelector(
                            "a.ql-preview"
                        );
                        return _this2;
                    }
                            ...
                            value: function highlight(_highlight) {
                                ...
                                if (this.cachedText !== text) {
                                    if (
                                        ...
                                        this.domNode.innerHTML = _highlight(
                                            text
                                        );
                            ...
                            function(type, range, oldRange, source) {
                                ...
                                if (
                                    ...
                                    if (lines.length === 1) {
                                        ...
                                        var index = _this2.quill.getIndex(
                                            lastLine
                                        );
                                        var length = Math.min(
                                            lastLine.length() - 1,
