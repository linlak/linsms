!(function () {
    ...
    require.config({
        ...
        shim: {
            ...
            'ngServices': {
                exports: 'ngServices',
                deps: ['angular', 'toaster', 'pusher-angular', 'pusher']
            },
            'app': ['angular', 'sanitize', 'animate', 'ngServices', 'ngTouch', 'uib', 'angular-ui-router', 'loadbar', 'toaster', 'pusher-angular', 'datetime-picker', 'bootstrapLightbox']
        }
    });
    require([
        'app',
